...
export const GetWhiteboardByIdSchema = z.object({
  ...
  /**
   * Includes operations associated with this whiteboard in the response, as defined in the `Operation` object. The
...
export type GetWhiteboardById = z.input<typeof GetWhiteboardByIdSchema>;
