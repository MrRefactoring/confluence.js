...
export const GetFooterCommentByIdSchema = z.object({
  ...
  /**
   * Includes content properties associated with this footer comment in the response. The number of results will be
  ...
  /**
   * Includes the current version associated with this footer comment in the response. By default this is included and
   * can be omitted by setting the value to `false`.
   */
  includeVersion: z.boolean().optional(),
});

export type GetFooterCommentById = z.input<typeof GetFooterCommentByIdSchema>;
