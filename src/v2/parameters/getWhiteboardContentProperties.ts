...
export const GetWhiteboardContentPropertiesSchema = z.object({
...
export type GetWhiteboardContentProperties = z.input<typeof GetWhiteboardContentPropertiesSchema>;
