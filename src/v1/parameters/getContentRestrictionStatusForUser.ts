...
export const GetContentRestrictionStatusForUserSchema = z.object({
...
export type GetContentRestrictionStatusForUser = z.input<typeof GetContentRestrictionStatusForUserSchema>;
