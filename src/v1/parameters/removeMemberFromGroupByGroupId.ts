...
export const RemoveMemberFromGroupByGroupIdSchema = z.object({
...
export type RemoveMemberFromGroupByGroupId = z.input<typeof RemoveMemberFromGroupByGroupIdSchema>;
