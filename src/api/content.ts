...
export class Content {
  ...
  async getContent<T = Models.ContentArray>(parameters: Parameters.GetContent | undefined, callback: Callback<T>): Promise<void>;
  /**
   * Returns all content in a Confluence instance.
   *
   * By default, the following objects are expanded: `space`, `history`, `version`.
  ...
  async getContent<T = Models.ContentArray>(parameters?: Parameters.GetContent, callback?: Callback<T>): Promise<void | T> {
    const config = {
      url: '/api/content',
      method: 'GET',
      params: {
  ...
  async createContent<T = Models.Content>(parameters: Parameters.CreateContent | undefined, callback: Callback<T>): Promise<void>;
  /**
   * Creates a new piece of content or publishes an existing draft.
   *
   * To publish a draft, add the `id` and `status` properties to the body of the request.
  ...
  async createContent<T = Models.Content>(parameters?: Parameters.CreateContent, callback?: Callback<T>): Promise<void | T> {
    const config = {
      url: '/api/content',
      method: 'POST',
      params: {
  ...
  async publishLegacyDraft<T = Models.Content>(parameters: Parameters.PublishLegacyDraft, callback: Callback<T>): Promise<void>;
  /**
   * Publishes a legacy draft of a page created from a blueprint. Legacy drafts
   * will eventually be removed in favor of shared drafts. For now, this method
   * works the same as [Publish shared draft](#api-content-blueprint-instance-draftId-put).
  ...
  async publishLegacyDraft<T = Models.Content>(parameters: Parameters.PublishLegacyDraft, callback?: Callback<T>): Promise<void | T> {
    const config = {
   ...
   * Permission to view the draft and 'Add' permission for the space that
   * the content will be created in. */
  async publishSharedDraft<T = Models.Content>(parameters: Parameters.PublishSharedDraft, callback: Callback<T>): Promise<void>;
  /**
   * Publishes a shared draft of a page created from a blueprint.
   *
   * By default, the following objects are expanded: `body.storage`, `history`, `space`, `version`, `ancestors`.
  ...
  async publishSharedDraft<T = Models.Content>(parameters: Parameters.PublishSharedDraft, callback?: Callback<T>): Promise<void | T> {
    const config = {
      url: `/api/content/blueprint/instance/${parameters.draftId}`,
      method: 'PUT',
      params: {
   ...
   * Permission to access the Confluence site ('Can use' global permission).
   * Only content that the user has permission to view will be returned. */
  async searchContentByCQL<T = Models.ContentArray>(parameters: Parameters.SearchContentByCQL, callback: Callback<T>): Promise<void>;
  /**
   * Returns the list of content that matches a Confluence Query Language
   * (CQL) query. For information on CQL, see:
   * [Advanced searching using CQL](https://developer.atlassian.com/cloud/confluence/advanced-searching-using-cql/).
   ...
   * Permission to access the Confluence site ('Can use' global permission).
   * Only content that the user has permission to view will be returned. */
  async searchContentByCQL<T = Models.ContentArray>(parameters: Parameters.SearchContentByCQL, callback?: never): Promise<T>;
  async searchContentByCQL<T = Models.ContentArray>(parameters: Parameters.SearchContentByCQL, callback?: Callback<T>): Promise<void | T> {
    const config = {
  ...
  async getContentById<T = Models.Content>(parameters: Parameters.GetContentById, callback?: Callback<T>): Promise<void | T> {
    const config = {
  ...
  async updateContent<T = Models.Content>(parameters: Parameters.UpdateContent, callback?: Callback<T>): Promise<void | T> {
    const config = {
      url: `/api/content/${parameters.id}`,
      method: 'PUT',
      params: {
  ...
  async getHistoryForContent<T = Models.ContentHistory>(parameters: Parameters.GetHistoryForContent, callback: Callback<T>): Promise<void>;
  /**
   * Returns the most recent update for a piece of content.
   *
   * **[Permissions](https://confluence.atlassian.com/x/_AozKw) required**: Permission to view the content. */
  async getHistoryForContent<T = Models.ContentHistory>(parameters: Parameters.GetHistoryForContent, callback?: never): Promise<T>;
  async getHistoryForContent<T = Models.ContentHistory>(parameters: Parameters.GetHistoryForContent, callback?: Callback<T>): Promise<void | T> {
    const config = {
