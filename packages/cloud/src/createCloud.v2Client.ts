import { type ClientConfig, createClient, type Buffer } from '@confluence.js/core';
...
export function createCloudV2Client(clientConfig: ClientConfig) {
...
export type CloudV2Client = ReturnType<typeof createCloudV2Client>;
