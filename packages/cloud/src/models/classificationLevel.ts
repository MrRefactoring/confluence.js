...
import { ClassificationLevelStatusSchema } from '#/models/classificationLevelStatus';
import { ClassificationLevelColorSchema } from '#/models/classificationLevelColor';
/**
 * A unit of [data
