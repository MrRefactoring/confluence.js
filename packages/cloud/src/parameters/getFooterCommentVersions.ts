...
import { VersionSortOrderSchema } from '../models/index.js';

export const GetFooterCommentVersionsSchema = z.object({
...
export type GetFooterCommentVersions = z.input<typeof GetFooterCommentVersionsSchema>;
