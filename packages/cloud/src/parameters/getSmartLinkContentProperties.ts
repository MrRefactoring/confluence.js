...
export const GetSmartLinkContentPropertiesSchema = z.object({
  ...
  /**
   * Maximum number of Smart Links per result to return. If more results exist, use the `Link` header to retrieve a
   * relative URL that will return the next set of results.
   */
  limit: z.number().optional(),
});

export type GetSmartLinkContentProperties = z.input<typeof GetSmartLinkContentPropertiesSchema>;
