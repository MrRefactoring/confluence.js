...
export const GetCustomContentContentPropertiesSchema = z.object({
...
export type GetCustomContentContentProperties = z.input<typeof GetCustomContentContentPropertiesSchema>;
