...
export async function getSpaceDefaultClassificationLevel(
  ...
  const config: SendRequestOptions<ClassificationLevel> = {
    url: `/spaces/${parameters.id}/classification-level/default`,
    method: 'GET',
...
export async function getPageClassificationLevel(
  ...
  const config: SendRequestOptions<ClassificationLevel> = {
    url: `/pages/${parameters.id}/classification-level`,
    method: 'GET',
    searchParams: {
...
export async function postPageClassificationLevel(
  ...
  const config: SendRequestOptions<void> = {
    url: `/pages/${parameters.id}/classification-level/reset`,
    method: 'POST',
    body: parameters.body,
  };
...
export async function getBlogPostClassificationLevel(
  ...
  const config: SendRequestOptions<ClassificationLevel> = {
    url: `/blogposts/${parameters.id}/classification-level`,
    method: 'GET',
    searchParams: {
      status: parameters.status,
    },
...
export async function postBlogPostClassificationLevel(
  ...
  const config: SendRequestOptions<void> = {
    url: `/blogposts/${parameters.id}/classification-level/reset`,
    method: 'POST',
    body: parameters.body,
  };
...
export async function getWhiteboardClassificationLevel(
  ...
  const config: SendRequestOptions<ClassificationLevel> = {
    url: `/whiteboards/${parameters.id}/classification-level`,
    method: 'GET',
    schema: ClassificationLevelSchema,
  };
...
export async function postWhiteboardClassificationLevel(
  ...
  const config: SendRequestOptions<void> = {
    url: `/whiteboards/${parameters.id}/classification-level/reset`,
    method: 'POST',
    body: parameters.body,
  };
...
export async function getDatabaseClassificationLevel(
  ...
  const config: SendRequestOptions<ClassificationLevel> = {
    url: `/databases/${parameters.id}/classification-level`,
    method: 'GET',
    schema: ClassificationLevelSchema,
  };
...
export async function postDatabaseClassificationLevel(
  ...
  const config: SendRequestOptions<void> = {
    url: `/databases/${parameters.id}/classification-level/reset`,
    method: 'POST',
    body: parameters.body,
  };
