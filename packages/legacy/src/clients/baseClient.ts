...
import { getAuthenticationToken } from '../services/index.js';
import type { Callback } from '../callback.js';
import type { Client } from './client.js';
import { ConfigSchema, type Config, type Error as ConfluenceError } from '../config.js';
  ...
  constructor(protected readonly config: Config) {
    ...
    try {
      ...
      if (e instanceof ZodError && e.errors[0].code === 'invalid_string') {
        throw new Error(e.errors[0].message, { cause: e });
      }
